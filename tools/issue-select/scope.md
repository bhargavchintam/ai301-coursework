...
I have about six years of applied ML and data engineering work, mostly in Python, plus SQL and some shell. I am comfortable with Git and with reading a backend or data-processing codebase. I want to get better at reading a codebase I did not write and at writing tests in the project's own style. I work full time and I am also a graduate student, so I prefer a bug with clear steps and a clear "done" that I can finish in a few evenings over an open-ended feature. Rank Python issues first, then documentation and tooling, then front-end work.
